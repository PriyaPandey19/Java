...
public class ArraysCC {
    ...
    public int heightChecker(int[] heights) {  //check how many heights are not in the expected order
      ...
      public int[] smallerNumbersThanCurrent(int[] nums) {   //find how many numbers are smaller than the current number
       //we will use a nested loop to count the number of smaller numbers for each number
       int n = nums.length;
